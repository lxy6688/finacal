...
class Wage extends BaseModel{
     ...
     * @return Array
     */
    public function addWage($uid,$postData=[]){
     ...
     * @return Array
     */
    public function getList($uid,$gid,$limit,$stime,$etime,$sort,$order){
        $param = [];
        $param['fields'] = 'id,user_id,pop_name,reserved_func,tax,total_pretax,real_wage,create_time,month,wid';
        if($limit){
            $param['limit'] = $limit;
        }
